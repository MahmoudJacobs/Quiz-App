...
import { getBaseUrl, getRequestHeaders } from "../../../../../Utils/Utils";
import { GroupInterface, QuizzCreateInterface } from "../../../../../InterFaces/InterFaces";
        ...
        <DialogPanel className="relative w-full max-w-md sm:max-w-lg m-auto mt-20 rounded-lg overflow-hidden bg-white shadow-lg">
          <div className="p-4 sm:p-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="font-bold text-2xl mb-5">Quiz successfully created</p>
              <div className="flex flex-row justify-between w-6/12 h-10 border border-black rounded-xl">
                ...
                <i className="p-3 mr-3 fa fa-clipboard #0c0a09 hover:bg-gray-100 hover:cursor-pointer"
